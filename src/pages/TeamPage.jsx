    ...
    <div className="min-h-screen">
            ...
            {team.map((member, index) => (
              <div key={index} className={`grid md:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                <div className={`${index % 2 === 1 ? 'md:order-2' : ''}`}>
                  <div className="bg-gradient-to-br from-[#0D9488] to-[#0F766E] rounded-3xl p-12 flex items-center justify-center h-96">
                ...
                <div className={`${index % 2 === 1 ? 'md:order-1' : ''}`}>
                  ...
                  <p className="text-2xl text-[#0D9488] font-semibold mb-6">{member.role}</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl p-12 border-2 border-[#0D9488]">
