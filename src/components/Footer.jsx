...
const Footer = () => {
  ...
  const solutions = [
    { label: 'Legal Consultation', href: '/practice-areas/consultation' },
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">© Copyright 2026 TIES Legal & Advisory. All Rights Reserved.</p>
          <div className="flex gap-6 text-sm">
            <a href="#terms" className="hover:text-[#0D9488] transition-colors">
              Terms and conditions
            </a>
            <a href="#privacy" className="hover:text-[#0D9488] transition-colors">
              Privacy policy
            </a>
          </div>
        </div>
