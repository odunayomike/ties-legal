      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 flex justify-center">
          <div className="relative w-full max-w-md">
            ...
            <div className="relative bg-gradient-to-br from-[#F5E6D3] to-[#E6D5C3] rounded-3xl p-8 transform hover:scale-105 transition-transform duration-300">
              <div className="flex justify-center">
                <div className="w-48 h-64 bg-gradient-to-br from-[#0D9488] to-[#0F766E] rounded-2xl flex items-center justify-center shadow-2xl">
